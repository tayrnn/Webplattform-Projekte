                ...
                <div class="flex gap-8">
                    <a href="/lehrende/alle-ideen"
                       class="font-bold text-lg transition-colors
                              {{ request()->is('lehrende/alle-ideen') || request()->is('lehrende')
                    ...
                    <a href="/lehrende/betreute-projekte"
                       class="font-bold text-lg transition-colors
                              {{ request()->is('lehrende/betreute-projekte')
                                   ? 'border-b-2 border-[#0066cc] text-[#0066cc]'
                                   : 'text-gray-400 hover:text-[#0066cc]' }}">
                        Betreute Projekte
                    </a>
                ...
                <div class="flex items-center gap-3 mb-1">
                    ...
                    <div class="relative" x-data="{ offen: false }" @click.outside="offen = false">
                        ...
                        <button @click="offen = !offen" type="button"
                            ...
                            Filter
                            @if($anzahl > 0)
                                <span class="inline-flex items-center justify-center w-5 h-5 text-xs font-bold bg-[#0066cc] text-white rounded-full">
                                    {{ $anzahl }}
                                </span>
                            @endif
                        ...
                        <div x-show="offen"
                            ...
                            <form method="GET" action="{{ url()->current() }}" id="filter-form">
                                ...
                                @foreach([
                                    ...
                                    <label class="flex items-center gap-3 px-2 py-1.5 rounded-lg cursor-pointer text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                    ...
                    {{-- Lehrende haben keinen "Neue Idee" Button --}}
                </div>
            </div>
