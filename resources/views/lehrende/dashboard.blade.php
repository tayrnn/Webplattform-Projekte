        ...
        <section class="flex-1">
            ...
            <div class="flex justify-between items-end border-b border-gray-300 mb-8 pb-3">
                ...
                <div class="flex gap-8">
                    <a href="/lehrende/alle-ideen" class="font-bold text-lg transition-colors
                              {{ request()->is('lehrende/alle-ideen') || request()->is('lehrende')
                                   ? 'border-b-2 border-[#0066cc] text-[#0066cc]'
                                   : 'text-gray-400 hover:text-[#0066cc]' }}">
Alle Ideen
</a>
<a href="/lehrende/betreute-projekte" class="font-bold text-lg transition-colors
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <x-project-card title="Drittes Projekt" status="Abgeschlossen" :needsSupervision="true" />
</div>
