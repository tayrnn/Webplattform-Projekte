...
@php
    ...
    $projekt = [
        ...
        'status'      => 'Offen',
        'beschreibung'=> 'Hier steht eine ausführliche Beschreibung der Projektidee. Ziel ist es, eine moderne Webanwendung zu entwickeln, die Studierenden und Lehrenden die Zusammenarbeit erleichtert.',
    ...
    $kommentare = [
        [
            ...
            'datum'  => 'vor 2 Tagen',
            'antworten' => [
                ['autor' => 'Max Mustermann', 'rolle' => 'Student', 'text' => 'Wir planen Laravel als Backend und Vue.js für das Frontend.', 'datum' => 'vor 1 Tag'],
                ['autor' => 'Lisa Weber',     'rolle' => 'Student', 'text' => 'Ich wäre auch dabei, falls noch Teammitglieder gesucht werden!', 'datum' => 'vor 1 Tag'],
            ],
        ],
        [
            'id'     => 2,
            ...
            'datum'  => 'vor 1 Tag',
            'antworten' => [
                ['autor' => 'Max Mustermann', 'rolle' => 'Student', 'text' => 'Vielen Dank! Ich melde mich diese Woche.', 'datum' => 'vor 20 Stunden'],
            ],
        ],
        [
            'id'     => 3,
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6">
        ...
        <div class="flex items-center justify-between border-t border-gray-100 pt-4">
            ...
            <div class="flex items-center gap-3 text-xs text-gray-400">
                <div class="w-7 h-7 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center font-bold uppercase">
            ...
            <div class="flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-opacity" title="{{ $projekt['bewertungen'] }} Bewertungen">
                <div class="flex text-yellow-400">
                    {{-- 4 Volle Sterne --}}
                    @for($i = 0; $i < floor($projekt['sterne']); $i++)
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <h2 class="text-base font-bold text-gray-700 flex items-center gap-2">
                <svg class="w-4 h-4 text-[#0066cc]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            @foreach($kommentare as $k)
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                    ...
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-8 h-8 rounded-full bg-[#d2f1ff] text-cyan-800 flex items-center justify-center font-bold text-xs uppercase">
                            {{ substr($k['autor'], 0, 2) }}
                        </div>
                        <div>
                        ...
                        <div class="ml-6 border-l-2 border-gray-100 pl-4 space-y-3 mb-3">
                            @foreach($k['antworten'] as $a)
                                <div class="flex gap-3">
                                    <div class="w-6 h-6 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center font-bold text-[10px] uppercase flex-shrink-0 mt-0.5">
                                        {{ substr($a['autor'], 0, 2) }}
                                    </div>
                                    <div>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5"
                    ...
                    @foreach($umfrage['optionen'] as $i => $option)
                        ...
                        <label class="block cursor-pointer" x-show="!abgestimmt">
                            <input type="radio" name="umfrage" value="{{ $i }}"
                                   x-model="gewählt" class="hidden">
                            <div class="flex items-center gap-3 px-3 py-2 rounded-lg border transition-all"
                                 :class="gewählt == '{{ $i }}'
                ...
                <div x-show="!abgestimmt">
                    <button @click="if(gewählt !== null) abgestimmt = true"
                            :disabled="gewählt === null"
            ...
            <div class="bg-blue-50 rounded-xl border border-blue-100 p-4">
                ...
                <p class="text-xs text-blue-600 leading-relaxed mb-3">
                    Du möchtest an diesem Projekt mitarbeiten? Schreib einen Kommentar oder kontaktiere den Autor direkt.
                </p>
