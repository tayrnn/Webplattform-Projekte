        ...
        <section class="flex-1">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="flex items-center gap-3 flex-wrap">
                            ...
                            <div x-data="{
                                ...
                                <div class="flex gap-0.5">
                                    @for($i = 1; $i <= 5; $i++)
                                        <span x-on:mouseenter="setHover({{ $i }})"
                ...
                <div class="flex flex-col gap-4">
                   ...
                   {{-- Aktionen für Projekte (Sichtbar für Besitzer ODER Admin) --}}
                    @if(auth()->check() && ($projekt->ersteller_id === auth()->id() || auth()->user()->role === 'admin'))
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 mb-3 relative" x-data="{ menuOpen: false, editDiscussion: false, zeigeAntwortBox: false }">
                        ...
                        <div class="flex justify-between items-start">
                            ...
                            @if(auth()->check() && ($diskussion->user_id === auth()->id() || auth()->user()->role === 'admin'))
                            <div class="relative">
