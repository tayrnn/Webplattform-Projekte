...
<div class="max-w-4xl mx-auto px-4 mt-6 mb-16">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-5 mb-4">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 flex-wrap">
            <div
                class="w-6 h-6 rounded-full bg-blue-50 text-blue-700 flex items-center justify-center text-xs font-semibold uppercase flex-shrink-0">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <a href="{{ route('diskussion.details', $diskussion->id) }}"
                ...
                <svg class="w-4 h-4 text-gray-300 group-hover:text-blue-400 flex-shrink-0 transition-colors" fill="none"
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-4 mt-2"
                ...
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Neues Diskussionsthema
                    erstellen</p>
                <form action="{{ route('diskussion.speichern', $projekt->id) }}" method="POST">
                    @csrf
                    <textarea name="title" x-model="text" placeholder="Thema eingeben..." rows="3"
                    ...
                    <div x-show="istUmfrage" class="mb-3 space-y-2">
                        ...
                        <template x-for="(opt, index) in optionen" :key="index">
                            <div class="flex gap-2">
                                ...
                                <button type="button" x-show="optionen.length > 2" @click="optionen.splice(index, 1)"
