...
<div class="max-w-2xl mx-auto px-6 mt-8 mb-12">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm text-center mb-6">
        <div
            class="w-20 h-20 bg-[#d2f1ff] rounded-full flex items-center justify-center border-4 border-white shadow-md mx-auto mb-3">
        ...
        <div
            class="mt-2 inline-block bg-[#eef2fd] text-[#0066cc] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-4">
                ...
                <span
                    class="text-red-500 text-xs mt-1 block">{{ implode(', ', $errors->updatePassword->get('current_password')) }}</span>
                @endif
            </div>
            ...
            <div class="mb-4">
                ...
                <span
                    class="text-red-500 text-xs mt-1 block">{{ implode(', ', $errors->updatePassword->get('password')) }}</span>
                @endif
            </div>
